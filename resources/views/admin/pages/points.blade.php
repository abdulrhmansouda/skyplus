                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" required
                                            placeholder="الادخال بالنسبة المؤية مثلا 1" name="commission" step="0.01">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-check-input" type="checkbox" value="true" id="isReligion"
                                            checked="" name="borrowing_is_allowed">
