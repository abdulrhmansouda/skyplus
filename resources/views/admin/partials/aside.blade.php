...
<div class="w-auto px-0 collapse navbar-collapse max-height-vh-100 h-100" id="sidenav-collapse-main">
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link @if(Route::currentRouteName() === "admin.points" ) active @endif" href="{{ route('admin.points') }}">
    ...
    <li class="nav-item">
          <button data-bs-toggle="collapse" data-bs-target="#setting" aria-expanded="false" aria-controls="setting" class="nav-link " href="../pages/setting.html">
            ...
            <span class="nav-link-text me-1">الاعدادات</span></button>
            <!-- add show when you need to open  -->
            <div class="collapse " id="setting">
               <ul class="ul-links">
                 <li class=""><a href="./setting1.html">الاعدادات الربط</a></li>
                 <li><a href="./setting2.html">تغير كلمة المرور</a></li>
               </ul>
