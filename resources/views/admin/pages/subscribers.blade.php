                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea cols="30" rows="3" required class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0 align-items-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0 text-xs font-weight-bold">alaa</p>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align-middle ">
                                        ...
                                        <div class="d-inline-block">
                                            ...
                                            <!-- satrt charge1 Modal -->
                                            <form action="{{ route('admin.subscribers.charge', $sub->id) }}" method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal fade" id="charge{{ $sub->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                هذا المشترك مغلق الرجاء تفعيل النقطة ومن ثم اضافة ايام
                                                            </div>
                                                            <div class="modal-footer">
