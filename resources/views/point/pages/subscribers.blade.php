                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <ul class="nav nav-tabs mb-3">
                                                                <li class="nav-item">
                                                                    <button type="button" class="nav-link active" data-tab="tab1-{{ $sub->id }}" onclick="openTab(event)">تسديد</button>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <button type="button" class="nav-link" data-tab="tab2-{{ $sub->id }}" onclick="openTab(event)">الغاء
                                                                        تسديد</button>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <button type="button" class="nav-link" data-tab="tab3-{{ $sub->id }}" onclick="openTab(event)">ترقية</button>
                                                                </li>
                                                            </ul>
                                                            <div class="tab-content">
                                                                <div class="tab-pane   active" id="tab1-{{ $sub->id }}">
                                                                    <!-- start tab 1 -->
                                                                    <form action="{{ route('point.subscribers.charge', $sub->id) }}" method="POST">
                                                                        @csrf
                                                                        <div class="row">
                                                                ...
                                                                <div class="tab-pane   " id="tab2-{{ $sub->id }}">
                                                                    <form action="{{ route('point.subscribers.uncharge', $sub->id) }}" method="POST">
                                                                        @csrf
                                                                        <!-- start tab 2 -->
                                                                        <div class="row">
                                                                            <div class=" col-6">
                                                                ...
                                                                <div class="tab-pane " id="tab3-{{ $sub->id }}">
                                                                    <!-- start tab3 -->
                                                                    <form action="{{ route('point.subscribers.switchPackageAndChargeRequest', $sub->id) }}" method="POST">
                                                                        @csrf <div class="row">
                                                                            <div class=" col-6">
                                                                                <div class="form-group">
                                                                                    <h6>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <ul class="nav nav-tabs mb-3">
                                                                <li class="nav-item">
                                                                    <button type="button" class="nav-link active" data-tab="tab4-{{ $sub->id }}" onclick="openTab(event)">نقل</button>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <button type="button" class="nav-link" data-tab="tab5-{{ $sub->id }}" onclick="openTab(event)">
                                                                        صيانة</button>
                                                                </li>
                                                            </ul>
                                                            <div class="tab-content">
                                                                <div class="tab-pane   active" id="tab4-{{ $sub->id }}">
                                                                    <form>
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <div class="form-group">
                                                                ...
                                                                <div class="tab-pane  " id="tab5-{{ $sub->id }}">
                                                                    <form>
                                                                        <div class="row">
                                                                            <div class="col-6">
                                                                                <div class="form-group">
