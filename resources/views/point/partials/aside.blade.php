<aside class="my-3 border-0 sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl fixed-end me-3 rotate-caret"
    ...
    <div class="w-auto px-0 collapse navbar-collapse max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if(Route::currentRouteName() === 'point.subscribers') active @endif" href="{{ route('point.subscribers') }}">
                    <div
            ...
            <li class="nav-item">
          <a class="nav-link " href="../pages/user-setting.html">
            <div
              class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md ms-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text me-1">معلومات التواصل</span>
          </a>
        </li>
            <li class="nav-item">
