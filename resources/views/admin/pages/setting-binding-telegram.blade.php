...
@section('content')
    <div class="container-fluid py-4">
        ...
        @endif
        <form action="{{ route('admin.setting.binding-telegram.charge-update') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="card col-md-7 mt-3">
                    <div class="card-header pb-0 p-3">
                        <h4 class="mb-0">اعدادات الربط مع مجموعة شحن المشتركين</h4>
                    </div>
    ...
    <div class="container-fluid py-4">
        ...
        @endif
        <form action="{{ route('admin.setting.binding-telegram.maintenance-update') }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="card col-md-7 mt-3">
