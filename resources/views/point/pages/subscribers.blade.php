                                            ...
                                            <td class="align-middle ">
                                                ...
                                                <div class="d-inline-block">
                                                    <a href="javascript:;"
                                                        ...
                                                        data-bs-toggle="modal" data-bs-target="#charge{{ $sub->id }}">
                                                                ...
                                                                @if ($sub->status !== 'closed')
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <ul class="nav nav-tabs mb-3">
                                                                            <li class="nav-item">
                                                                                <button type="button"
                                                                                    class="nav-link active" data-tab="tab1"
                                                                                    onclick="openTab(event)">تسديد</button>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <button type="button"
                                                                                    class="nav-link" data-tab="tab2"
                                                                                    onclick="openTab(event)">الغاء
                                                                                    تسديد</button>
                                                                            </li>
                                                                            <li class="nav-item">
                                                                                <button type="button"
                                                                                    class="nav-link" data-tab="tab3"
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <form action="{{ route('point.subscribers.maintenance', $sub->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
