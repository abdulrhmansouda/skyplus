                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach ($subs as $sub)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->t_c}}</p>
                                            </td>
                                            {{-- <td>
                                                    <p class="text-xs font-weight-bold mb-0">100 </p>
                                                </td> --}}
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->subscriber_number }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->mother }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->phone }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->created_at }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $sub->package->name }}</p>
                                            </td>
                                            ...
                                            <td class="align-middle ">
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <!-- end Modal view1  -->
                                                    <div class="modal fade" id="view{{ $sub->id }}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <!-- satrt edit Modal -->
                                                    <form action="">
                                                        <div class="modal fade" id="edit{{ $sub->id }}" tabindex="-1" role="dialog"
                                                ...
                                                <div class="d-inline-block">
                                                    ...
                                                    <!--start delete Modal -->
                                                    <div class="modal fade" id="delete{{ $sub->id }}" tabindex="-1" role="dialog"
