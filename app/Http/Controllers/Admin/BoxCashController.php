...
use App\Exports\AdminBoxCashExport;
// use App\Exports\AccountantBoxCashExport;
use App\Http\Controllers\Controller;
use App\Http\Requests\Admin\StoreBoxCashRequest;
...
class BoxCashController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pages.box-cash', [
    ...
    {
        $export = new AdminBoxCashExport($request);
        $time = now()->format('Y_m_d');
        return Excel::download($export, "AdminBoxCashExport_{$time}.xlsx");
    }
