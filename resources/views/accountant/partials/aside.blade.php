<aside class="my-3 border-0 sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl fixed-end me-3 rotate-caret" id="sidenav-main" data-color="info">
    ...
    <div class="w-auto px-0 collapse navbar-collapse max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if (Route::currentRouteName() === 'accountant.home') active @endif " href="{{ route('accountant.home') }}">
            ...
            <li class="position-relative nav-item">
                ...
                <div class="collapse @if (Route::currentRouteName() === 'accountant.box-cash.index' || Route::currentRouteName() === 'accountant.box-bank.index' || Route::currentRouteName() === 'admin.setting.social.index' || Route::currentRouteName() === 'admin.setting.other.index') show @endif" id="box">
                    <ul class="ul-links">
                        <li class="mb-1 position-relative @if (Route::currentRouteName() === 'accountant.box-cash.index') active @endif"><a href="{{ route('accountant.box-cash.index') }}">النقد </a>

                        </li>

                        <li class="mb-1 position-relative @if (Route::currentRouteName() === 'accountant.box-bank.index') active @endif"><a href="{{ route('accountant.box-bank.index') }}">البنك</a>
                        </li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link  @if(Route::currentRouteName() === 'accountant.setting.change-password.index') active @endif" href="{{ route('accountant.setting.change-password.index') }}">
                    <div class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md ms-2 d-flex align-items-center justify-content-center">
