                                    ...
                                    <div class="form-group">
                                        <label for="img" class="w-100">الصورة
                                            ...
                                            <img src="{{ asset('/assets/img/add.png') }}" alt="pos image"
                                                class="mx-auto border rounded-circle d-block" width="150">
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" required
                                            placeholder="الادخال بالنسبة المؤية مثلا 1" name="commission">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <h6 class="w-100">الصورة
                                                                                    <img src="{{ $point->imageUrl }}"
                                                                                        alt="pos image"
                                                                                        class="mx-auto border rounded-circle d-block"
                                                                                        width="150">
                                                                                </h6>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label for="img{{ $point->id }}"
                                                                                        ...
                                                                                        <img src="{{ $point->imageUrl }}"
                                                                                            alt="pos image"
                                                                                            class="mx-auto border rounded-circle d-block object-cover"
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        ...
                                                                                        placeholder="ادخل ال T.C" value="{{ $point->t_c }}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="number"
                                                                                        class="form-control" required
                                                                                        placeholder="الادخال بالنسبة المؤية مثلا 1" name="{{ $point->commission }}">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea class="form-control" rows="3" name="description"
                                                                                        placeholder="ادخل العنوان">{{ $point->address }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
