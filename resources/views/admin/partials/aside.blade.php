<aside class="my-3 border-0 sidenav navbar navbar-vertical navbar-expand-xs border-radius-xl fixed-end me-3 rotate-caret" id="sidenav-main" data-color="info">
    ...
    <div class="w-auto px-0 collapse navbar-collapse max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link @if (Route::currentRouteName() === 'admin.points.index') active @endif" href="{{ route('admin.points.index') }}">
                    ...
                    <span class="nav-link-text me-1">نقاط البيع</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (Route::currentRouteName() === 'admin.subscribers.index') active @endif" href="{{ route('admin.subscribers.index', ['pagination_number' => 10]) }}">
                    <div class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md ms-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text me-1">المشتركين</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link @if (Route::currentRouteName() === 'admin.packages.index') active @endif" href="{{ route('admin.packages.index') }}">
                    <div class="text-center bg-white shadow icon icon-shape icon-sm border-radius-md ms-2 d-flex align-items-center justify-content-center">
            ...
            <li class="position-relative nav-item">
                ...
                <div class="collapse @if (Route::currentRouteName() === 'admin.support.index' || Route::currentRouteName() === 'admin.support.index' || Route::currentRouteName() === 'admin.setting.social.index' || Route::currentRouteName() === 'admin.setting.other.index') show @endif" id="support">
                    <ul class="ul-links">
                        <li class="mb-1 position-relative @if (Route::currentRouteName() === 'admin.support.index') active @endif"><a href="{{ route('admin.support.index') }}">لمشتركين أساسيين</a>
                            <!-- if  -->
                            <span class="bg-danger red-point"></span>
                            <!-- end if  -->
                        </li>

                        <li class="mb-1 position-relative @if (Route::currentRouteName() === 'admin.support.index') active @endif"><a href="{{ route('admin.support.index') }}">لمشتركين جدد</a>
                            <!-- if  -->
                            <span class="bg-danger red-point"></span>
                            <!-- end if  -->
            ...
            <li class="nav-item">
                ...
                <div class="collapse @if (Route::currentRouteName() === 'admin.setting.binding-telegram.index' || Route::currentRouteName() === 'admin.setting.change-password.index' || Route::currentRouteName() === 'admin.setting.social.index' || Route::currentRouteName() === 'admin.setting.other.index') show @endif" id="setting">
                    <ul class="ul-links">

                        @if (Auth::user()->isSuperAdmin())
                        <li class="mb-1 @if (Route::currentRouteName() === 'admin.setting.binding-telegram.index') active @endif"><a href="{{ route('admin.setting.binding-telegram.index') }}">اعدادات ربط
                                تيليجرام</a></li>
                        @endif
