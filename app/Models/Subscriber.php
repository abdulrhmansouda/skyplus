...
class Subscriber extends Model
{
    ...
    {
        switch ($this->status) {
            case (UserStatusEnum::ACTIVE->value):
                return '<span class="badge badge-sm bg-gradient-success">مفعل</span>';
            case (UserStatusEnum::INACTIVE->value):
                return '<span class="badge badge-sm bg-gradient-warning">غير مفعل</span>';
            case (UserStatusEnum::CLOSED->value):
                return '<span class="badge badge-sm bg-gradient-danger">مغلق</span>';
        }
    }
